...
-- --------------------------------------------------
-- Date Created: 08/20/2021 17:06:21
-- Generated from EDMX file: C:\Users\Tarde\source\repos\juanmagv\CURSO_NET\ModelFirst2\ModelFirst2\Model1.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[PUESTOSet] (
    ...
    [NIVEL_RIESGO_MIN] float  NOT NULL,
...
-- Creating table 'TIPO_DEDUCCIONSet'
CREATE TABLE [dbo].[TIPO_DEDUCCIONSet] (
...
-- Creating primary key on [ID_TIPO_DEDUCCION] in table 'TIPO_DEDUCCIONSet'
ALTER TABLE [dbo].[TIPO_DEDUCCIONSet]
ADD CONSTRAINT [PK_TIPO_DEDUCCIONSet]
...
ALTER TABLE [dbo].[REGISTRO_TRANSACCION_DEDUCCIONSet]
ADD CONSTRAINT [FK_TIPO_DEDUCCIONREGISTRO_TRANSACCION_DEDUCCION]
    FOREIGN KEY ([ID_TIPO_DEDUCCION])
    REFERENCES [dbo].[TIPO_DEDUCCIONSet]
        ([ID_TIPO_DEDUCCION])
    ON DELETE CASCADE ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_TIPO_DEDUCCIONREGISTRO_TRANSACCION_DEDUCCION'
CREATE INDEX [IX_FK_TIPO_DEDUCCIONREGISTRO_TRANSACCION_DEDUCCION]
ON [dbo].[REGISTRO_TRANSACCION_DEDUCCIONSet]
    ([ID_TIPO_DEDUCCION]);
GO
